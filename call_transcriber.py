...
2. Transcribes them using Deepgram REST API 
...
# ============================================================================
# Option 1: Hardcode your keys here (easier but less secure)
DEEPGRAM_API_KEY = os.getenv("DEEPGRAM_API_KEY", "")  # Put your Deepgram API key here
OPENROUTER_API_KEY = os.getenv("OPENROUTER_API_KEY", "")  # Put your OpenRouter API key here
